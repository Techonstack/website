    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Good technology is crafted with effective planning"
            description="We are a solution oriented technology team with a key focus on delivering quality solutions"
          />
