...
const data = [
  {
    ...
    title: `We will turn your ideas into reality by using modern tech development practices`,
    description: `We use the DRY (Do not Repeat Yourself) tech development method to create solutions that are built to last.`,
  ...
  },
  {
    ...
    title: `We will turn your ideas into reality by using modern tech development practices`,
    description: `Using modern practices like scrum, we provide flexible and quickly-deliverable product features.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Sprint Plannings',
  ...
  {
    id: 3,
    tabTitle: 'What’s our tech support plan?',
    title: `We will turn your ideas into reality by using modern tech development practices`,
    description: `We ensure that your products are services are highly optimized and scalable by providing first level support for all products.`,
    moreLink: '#explore-more',
    image: tabImage1,
    list: [
      'Robust Tech',
