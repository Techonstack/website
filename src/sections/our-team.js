...
const data = [
  ...
  },
  {
    ...
    avatar: avatar4,
    name: 'Bashir Ismail',
    designation: 'User interface designer (UI/UX)',
    socialLinks: [
      {
        name: 'twitter',
        link: 'http://twitter.com',
    ...
    <Box as="section" id="team" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          ...
          description="Our team of experts help you deliver your project milestones and achieve your business bottom line"
        />
      </Container>
      <Box
        sx={{
